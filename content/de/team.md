...
title: Team
cursivWord1: Easy
cursivWord2: professionell
headerLine1: im Umgang und
headerLine2: im Geschäft
images:
  - src: /images/team/team_ervin-lukacs-unsplash.webp
    ...
    alignment: left
  - src: /images/team/team_jehyun-sung-unsplash.webp
    alt: Hero image showing Berlin skyline
    ...
    alignment: right
  - src: /images/team/team_tobias-mrzyk-unsplash.webp
    alt: Hero image showing Berlin skyline
    text: "Verlässlichkeit und Schnelligkeit sind die Basis einer guten Zusammenarbeit. Ob eine Grafik optimiert oder die ganze Sendung gesteuert werden muss: Wir kriegen das hin - dank flexiblem Setup sind wir startklar, wenn man uns braucht."
    alignment: left
  - src: /images/team/team_samrat-khadka-unsplash.webp
    alt: Hero image showing Berlin skyline
    text: "Unser Ziel: Sendungen so innovativ und einzigartig wie möglich zu machen - hinter den Kulissen hochkomplex, aber easy im Umgang."
    alignment: right
type: team
---
...
::indented-text-block
Seit 2010 aus Berlin live in die Welt
